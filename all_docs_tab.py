    ...
    for i, doc in enumerate(docs):
        with cols[i % 2]:
            ...
            def get_ai_cyber_analysis(content, score):
                ...
                return f"""This document demonstrates an AI Cybersecurity maturity score of {score}/100. • Document addresses AI security considerations and risk assessment frameworks • Content includes guidance on AI system protection and threat mitigation • Assessment shows {'excellent' if score_num >= 75 else 'good' if score_num >= 50 else 'developing'} AI cybersecurity practices <br><b>RECOMMENDATIONS:</b> • Continue implementing robust AI security measures • Regular assessment of AI system vulnerabilities • Integration with existing cybersecurity frameworks"""
            ...
            def get_ai_ethics_analysis(content, score):
                ...
                return f"""This document demonstrates an AI Ethics score of {score}/100. • Document addresses ethical AI considerations and bias prevention measures • Content includes fairness, transparency, and accountability frameworks • Assessment shows {'excellent' if score_num >= 75 else 'good' if score_num >= 50 else 'developing'} AI ethics practices <br><b>RECOMMENDATIONS:</b> • Implement comprehensive bias detection systems • Regular ethical AI audits and assessments • Stakeholder engagement in AI ethics governance"""
